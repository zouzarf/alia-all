        ...
        <>
            ...
            <Card className="max-w-[340px]">
                ...
                <CardBody className="px-3 py-0 text-small text-default-400">
                    ...
                    <span className="pt-2">
                        <p>From {DateTime.fromJSDate(scheduleStats.minDate!).toLocaleString(DateTime.DATETIME_SHORT)}</p>
                        <p>To {DateTime.fromJSDate(scheduleStats.maxDate!).toLocaleString(DateTime.DATETIME_SHORT)} </p>
                    </span>
                </CardBody>
